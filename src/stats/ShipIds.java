...
public class ShipIds {
	...
	static
	{
		...
		shipId.put("FFNF Emile Bertin","802014");
		...
		shipId.put("FFNF Le Temeraire","801034");
		...
		shipId.put("MNF La GalissonniÃ¨re","902014");
		...
		shipId.put("La GalissonniÃ¨re.META", "9702044");
		...
		shipId.put("Jintsū.META", "9702054");
		shipId.put("Jintsuu META", "9702054");
		shipId.put("Unzen", "303194");
		shipId.put("Owari", "305134");
		shipId.put("Hatsuzuki", "301894");
		shipId.put("Natori", "302064");
		shipId.put("Asanagi", "301904");
		shipId.put("Princeton META", "9706034");
		shipId.put("Princeton.META", "9706034");
		shipId.put("Houston II", "102314");
		shipId.put("São Martinho", "9600024");
		shipId.put("Golden Hind", "9600034");
		...
		shipId.put("Yumi", "11000044");
		shipId.put("Fubuki (SK)", "11000054");
		shipId.put("Murasaki", "11000064");
		shipId.put("Yūyaki", "11000071");
